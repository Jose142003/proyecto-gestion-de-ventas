...
<head>
    ...
    <title>Pago Móvil | Proyectos Industriales</title>
...
<div class="container">
    <div class="header">
        ...
        <h2><?php echo \I18n::trans('mobile_payment'); ?></h2>
        <p><?php echo \I18n::trans('confirm_payment'); ?></p>
    </div>
    ...
    <div class="content">
        ...
        <div class="bank-info">
            <h4><i class="fas fa-university"></i> <?php echo \I18n::trans('mobile_payment_details'); ?></h4>
            ...
            <div id="bancoMercantil">
                ...
                <p><strong><?php echo \I18n::trans('phone'); ?></strong> 0414-3417373</p>
                <p><strong><?php echo \I18n::trans('id_number'); ?></strong> V-5.687.588</p>
                <p><strong><?php echo \I18n::trans('holder'); ?></strong> Jose Chacon</p>
            </div>
            <div id="bancoProvincial" style="display:none">
                <p><strong><?php echo \I18n::trans('bank'); ?></strong> Provincial</p>
                <p><strong><?php echo \I18n::trans('phone'); ?></strong> 0416-7234581</p>
                <p><strong><?php echo \I18n::trans('id_number'); ?></strong> V-5.687.588</p>
                <p><strong><?php echo \I18n::trans('holder'); ?></strong> Jose Chacon</p>
            </div>
        </div>
        ...
        <div class="reference-field">
            <label>
                <i class="fas fa-hashtag"></i> <?php echo \I18n::trans('ref_number_mobile'); ?>
            </label>
        ...
        <button class="btn-confirm" id="btnConfirm" onclick="procesarPago()" disabled>
            <i class="fas fa-check-circle"></i> <?php echo \I18n::trans('confirm_payment'); ?>
        </button>
...
async function procesarPago() {
    ...
    if (!referencia) {
        mostrarError('Por favor, ingresa el número de referencia del pago');
        return;
    }
    ...
    try {
        ...
        // Preparar productos con el formato correcto
        ...
        if (result.success) {
            // Guardar productos en sessionStorage para respaldo
            sessionStorage.setItem('productos_pedido', JSON.stringify(productosEnvio));
            
            // Convertir productos a JSON para pasar por URL
            ...
            // Redirigir con todos los parámetros incluyendo clientType
            window.location.href = `pedido_confirmado.php?numero=${result.numero_pedido}&total=${totalPagar}&metodo=pago_movil&referencia=${encodeURIComponent(referencia)}&usuario_id=${user_id}&productos=${productosJson}&clientType=${clientType}`;
        } else {
