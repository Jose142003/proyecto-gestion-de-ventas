...
VALUES ('Administrador', 'picca.ventas@gmail.com', 'admin', SHA2('admin123', 256), 'superadmin');

INSERT INTO admin_users (nombre, correo, usuario, contrasena, rol) VALUES
('Vendedor 1', 'vendedor1@empresa.com', 'vendedor1', SHA2('vendedor123', 256), 'vendedor'),
('Admin 2', 'admin2@empresa.com', 'admin2', SHA2('admin456', 256), 'admin');
