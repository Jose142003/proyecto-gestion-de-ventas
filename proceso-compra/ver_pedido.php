...
try {
    ...
    if ($admin_check) {
        ...
        if ($admin_user) {
            ...
            if (!$stmt->fetch()) {
                header('Location: /proyecto/usuario/pagina_modernizada.html');
                exit;
            }
    ...
    <div class="container">
        <div class="header no-print">
            ...
            <div class="header-actions">
                ...
                <a href="/proyecto/admin-panel/panel_admin.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Volver</a>
            </div>
        </div>
