...
try {
    ...
    if ($admin_check) {
        ...
        if ($admin_user) {
            ...
            if (!$stmt->fetch()) {
                header('Location: /proyecto/interfaz usuario/pagina_modernizada.html');
                exit;
            }
...
<body>
    <div class="container">
        <div class="header no-print">
            ...
            <div class="header-actions">
                ...
                <a href="/proyecto/panel admin/panel_admin.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Volver</a>
            </div>
        </div>
    ...
    <script>
        ...
        async function guardarNotas() {
            ...
            try {
                const response = await fetch('/proyecto/proceso compra/actualizar_pedido.php', {
                    method: 'POST',
