...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // PASO 5: Para cada cliente, eliminar sus facturas y dependencias
        ...
        // PASO 7: Eliminar items del carrito
        $stmt = $db->prepare("DELETE FROM cart_items WHERE user_id = ?");
        $stmt->execute([$user_id]);
        
        // PASO 8: Eliminar detalles de pedidos
        $stmt = $db->prepare("
        ...
        // PASO 9: Eliminar pedidos
        $stmt = $db->prepare("DELETE FROM pedidos WHERE usuario_id = ?");
        $stmt->execute([$user_id]);
        
        // PASO 10: Eliminar foto de perfil si existe
        ...
        // PASO 11: Finalmente eliminar usuario
