...
CREATE TABLE `backups` (
  ...
  KEY `idx_fecha` (`fecha_creacion`),
  KEY `idx_tipo` (`tipo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Registro de copias de seguridad';
...
CREATE TABLE `configuracion_sistema` (
  ...
  KEY `idx_grupo` (`grupo`),
  KEY `idx_clave` (`clave`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Configuración del sistema';
...
INSERT INTO `configuracion_sistema` (`id`, `clave`, `valor`, `tipo`, `grupo`, `descripcion`, `editable`, `orden`, `created_at`, `updated_at`) VALUES ('15','','','text','general',NULL,'1','0','2026-04-10 14:29:59','2026-04-11 08:03:15');
